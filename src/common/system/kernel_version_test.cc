...
TEST(LinuxHeadersUtils, GenAutoConf) {
  const std::string kConfigFile = testing::BazelRunfilePath("src/common/system/testdata/config");
...
TEST(LinuxHeadersUtils, GenAutoConfGz) {
  const std::string kConfigFile =
      testing::BazelRunfilePath("src/common/system/testdata/config.gz");
...
TEST(LinuxHeadersUtils, FindClosestPackagedLinuxHeaders) {
  const std::string kTestSrcDir =
      testing::BazelRunfilePath("src/common/system/testdata/test_header_packages");

  std::string prefix = "src/common/system/testdata/test_header_packages/linux-headers-";
#if X86_64
