...
TEST_F(StringifierTest, MemoizationTest) {
  ...
  LOG(INFO) << "3 open file descriptors: " << CountOpenFileDescriptors();
  ASSERT_OK(bcc_wrapper_->AttachUProbe(kFooUprobe));
  LOG(INFO) << "4 open file descriptors: " << CountOpenFileDescriptors();
  ASSERT_OK(bcc_wrapper_->AttachUProbe(kBarUprobe));
  LOG(INFO) << "5 open file descriptors: " << CountOpenFileDescriptors();
  ...
  LOG(INFO) << "6 open file descriptors: " << CountOpenFileDescriptors();
  bcc_wrapper_->Close();
  LOG(INFO) << "7 open file descriptors: " << CountOpenFileDescriptors();
  ...
  LOG(INFO) << "8 open file descriptors: " << CountOpenFileDescriptors();
  ...
  LOG(INFO) << "9 open file descriptors: " << CountOpenFileDescriptors();
  ...
  LOG(INFO) << "10 open file descriptors: " << CountOpenFileDescriptors();
}
