...
class FDLeakTest : public testing::SocketTraceBPFTestFixture<>,
                       public ::testing::WithParamInterface<std::string_view> {};

TEST(FDLeakTest, SimpleFDCountTest) {
...
TEST_P(FDLeakTest, UnclosedConnection) {
...
INSTANTIATE_TEST_SUITE_P(SocketTypeSuite, FDLeakTest, ::testing::Values(kTCPServerPath));
