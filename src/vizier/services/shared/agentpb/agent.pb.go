...
func (m *KernelVersion) GetMinor() int32 {
	if m != nil {
		return m.Minor
	}
	return 0
...
func (m *KernelVersion) GetMajor() int32 {
	if m != nil {
		return m.Major
	}
	return 0
...
func (m *KernelVersion) GetPatch() int32 {
	if m != nil {
		return m.Patch
	}
	return 0
...
var fileDescriptor_fef0af3bd5248f34 = []byte{
	...
	,
}
