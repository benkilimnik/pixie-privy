...
from privy.providers.generic import MacAddress, IMEI, Gender, Passport, DriversLicense, String, ITIN, Religion, RaceEthnicity
...
class English_US(GenericProvider):
    def __init__(self, pii_types=None, locale="en_US", fake_persons_file_path=""):
        ...
        if fake_persons_file_path and Path(fake_persons_file_path).exists():
            ...
            url = "https://raw.githubusercontent.com/benkilimnik/pii-data/main/FakeNameGenerator.com_40000_American.csv"
        ...
        custom_faker.add_provider(RaceEthnicity)
        custom_faker.add_provider(DriversLicense)
