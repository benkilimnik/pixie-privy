...
from privy.strategies import FakerStrategies
...
class SchemaHooks:
    ...
    def payload_generator_hook(self) -> None:
        ...
        def before_generate_case(context, strategy):
            ...
            # overwrite values generated by default schemathesis strategies (data generators)
